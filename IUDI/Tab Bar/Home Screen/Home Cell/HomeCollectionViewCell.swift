...
class HomeCollectionViewCell: UICollectionViewCell,DateConvertFormat,ServerImageHandle {
    ...
    @IBOutlet weak var dislikeImageYconstant: NSLayoutConstraint!
    @IBOutlet weak var dislikeImageSize: NSLayoutConstraint!
    ...
    func setup(){
        ...
        UIView.animate(withDuration: 3) {
            ...
            self.dislikeImageYconstant.constant = -400
            self.dislikeImageSize.constant = 300
            self.dislikeImage.isHidden = (self.dislikeImageSize.constant == 50) ? false : true
            self.cellUiView.layoutIfNeeded()
        }
    }
